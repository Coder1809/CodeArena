    ...
    return (
      <div className="page-wrapper page-wrapper--narrow">
        <div className="card" style={{ textAlign: 'center' }}>
          ...
          <button className="btn btn--auto" onClick={() => navigate('/create')}>
      ...
      <div className="card">
        ...
        {roomData.status === 'WAITING' && (
          <div className="center-state">
            ...
            <button className="btn btn--auto btn--lg" onClick={handleStartMatch}>
          ...
          <div className="winner-display">
            ...
            <p>
              {roomData.winner ? (
                ...
                'Match time expired with no solutions submitted. Result: Draw.'
              )}
            </p>
