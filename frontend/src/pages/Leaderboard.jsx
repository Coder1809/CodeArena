            ...
            <table className="league-table" role="table">
              <thead>
                <tr>
                  ...
                  <th scope="col" style={{ textAlign: 'center' }}>Draws</th>
              ...
              <tbody>
                {players.map((p, index) => (
                  <tr key={p.id}>
                    ...
                    <td style={{ textAlign: 'center', color: 'var(--text-secondary)', fontFamily: 'var(--font-mono)' }}>
                      {p.draws || 0}
                    </td>
                    <td style={{ textAlign: 'center', fontWeight: 'bold', fontFamily: 'var(--font-mono)' }}>
                      {p.matches_played ?? ((p.wins || 0) + (p.losses || 0) + (p.draws || 0))}
                    </td>
                  </tr>
                ))}
              </tbody>
